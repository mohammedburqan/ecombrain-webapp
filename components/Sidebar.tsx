  ...
  return (
    <div className="hidden md:flex w-64 flex-col bg-[#152042] border-r border-[#2a3b75]">
      ...
      <div className="flex-1 flex flex-col gap-1 p-4 overflow-y-auto">
        <div className="text-xs font-semibold text-white/50 mb-2 px-2 uppercase tracking-wider">Platform</div>
        {navigation.map((item) => {
        ...
        {userRole === 'admin' && (
          <>
            <div className="text-xs font-semibold text-white/50 mb-2 px-2 uppercase tracking-wider mt-4">Administration</div>
      ...
      <div className="p-4 border-t border-[#2a3b75]">
        <button 
          ...
          className="flex w-full items-center gap-3 px-3 py-2 rounded-md text-sm font-medium text-white/70 hover:text-white hover:bg-red-500/10 transition-colors"
        >
