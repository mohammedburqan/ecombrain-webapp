    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-[#1e2d5f] p-6 rounded-xl border border-[#2a3b75]">
          <h3 className="text-gray-400 text-sm font-medium">Store Success Rate</h3>
        ...
        <div className="bg-[#1e2d5f] p-6 rounded-xl border border-[#2a3b75]">
          <h3 className="text-gray-400 text-sm font-medium">Task Success Rate</h3>
          <p className="text-3xl font-bold mt-2 text-white">
        ...
        <div className="bg-[#1e2d5f] p-6 rounded-xl border border-[#2a3b75]">
          <h3 className="text-gray-400 text-sm font-medium">Total Stores</h3>
      ...
      <div className="bg-[#1e2d5f] p-6 rounded-xl border border-[#2a3b75]">
        ...
        <div className="space-y-4">
          <div>
            <p className="text-sm text-gray-300">Total Jobs: <span className="text-white font-semibold">{roiData.roi?.totalJobs || 0}</span></p>
            <p className="text-sm text-gray-300">Successful Jobs: <span className="text-white font-semibold">{roiData.roi?.successfulJobs || 0}</span></p>
          </div>
          <div>
            <p className="text-sm text-gray-300">Total Tasks: <span className="text-white font-semibold">{roiData.roi?.totalTasks || 0}</span></p>
            <p className="text-sm text-gray-300">Successful Tasks: <span className="text-white font-semibold">{roiData.roi?.successfulTasks || 0}</span></p>
          </div>
        </div>
      </div>
    </div>
